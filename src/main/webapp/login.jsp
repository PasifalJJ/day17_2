    ...
    <form action="${pageContext.request.contextPath}/user/checkLogin" method="post">
        ...
        <div class="form-inline">
            ...
            <input type="text" name="checkCode" class="form-control" id="checkCode" placeholder="请输入验证码"
                   style="width: 120px;"/>
            <a href="javascript:refreshCode()"><img src="${pageContext.request.contextPath}/code/getCheckCode"
...
<script>
    function refreshCode() {
        var vcodeEle = document.getElementById("vcode");
        vcodeEle.src = "${pageContext.request.contextPath}/code/getCheckCode?time=" + new Date().getTime();
    }
</script>
</body>
</html>
